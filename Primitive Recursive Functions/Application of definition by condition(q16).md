Give one application of definition by conditions and one by bounded minimization which show the utility of knowing that these operations are primitive 
recursive.
